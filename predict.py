...
# Local application imports - import directly from package
import config
...
def main():
    ...
    if not os.path.exists(args.model_path):
        ...
        print("Please train the model first using 'python -m src.train' (if running from root) or 'python train.py' (if running from .")
        return
